...
<div class="container">
  ...
  <form action="index.html" method="post"> <!-- Form for selecting repositories -->
    <?php
    $search_criteria = ''; // Initialize search_criteria variable
    //if(isset($_POST['language']) && isset($_POST['skill']) && isset($_POST['skillLevel'])){
        $lang = 'javascript';//$_POST['language'];
        $skill = 'react';//$_POST['skill'];
        $skillLevel = 'b';//$_POST['skillLevel'];
